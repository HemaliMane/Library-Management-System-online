				...
				//ADMIN LOGIN...
					...
					if(isset($_REQUEST['adminLoginBtn'])){
						...
						if(!empty($username) && !empty($pwd)){
							...
							$query = mysqli_query("SELECT id,username,pwd FROM admin WHERE username = '$username'");
				...
				//STUDENT LOGIN...
					...
					if(isset($_REQUEST['studentLoginBtn'])){
						...
						if(!empty($username) && !empty($pwd)){
							...
							$query = mysqli_query("SELECT id,username,pwd FROM members WHERE position = 'Student' && username = '$username' && pwd = '$pwd'");
							$result = mysqli_fetch_assoc($query);
				...
				//FACULTY LOGIN...
					...
					if(isset($_REQUEST['facultyLoginBtn'])){
						...
						if(!empty($username) && !empty($pwd)){
							...
							$query = mysqli_query("SELECT id,username,pwd FROM members WHERE position = 'Faculty' && username = '$username' && pwd = '$pwd'");
							$result = mysqli_fetch_assoc($query);
				...
				//ADD MEMBER...
                    ...
                    if(isset($_REQUEST['addMemberBtn'])){
                        ...
                        if(!empty($memberId) && !empty($firstName) && !empty($lastName) && !empty($username) && !empty($pwd) && !empty($mobile)){
                        	...
                        	$usernameExists = mysqli_fetch_assoc(mysqli_query("SELECT username FROM members WHERE username = '$username'"));

                            if($usernameExists['username'] != $username){

                            	$mobileExists = mysqli_fetch_assoc(mysqli_query("SELECT mobile FROM members WHERE mobile = '$mobile'"));

                            	if($mobileExists['mobile'] != $mobile){

                            		$emailExists = mysqli_fetch_assoc(mysqli_query("SELECT email FROM members WHERE email = '$email'"));
                ...
                //FORGET PASSWORD...
                	...
                	if(isset($_REQUEST['pwdSaveBtn'])){
                		...
                		if($request == "admin"){
							...
							$query = mysqli_query("SELECT email FROM admin WHERE email = '$regEmail'");
							$result = mysqli_fetch_assoc($query);
							...
							if($regEmail == $result['email']){
								...
								if($newP == $confirmP){
									$query = mysqli_query("UPDATE admin SET pwd = '$newP' WHERE email = '$regEmail'");
							...
							$query = mysqli_query("SELECT email,position FROM members WHERE email = '$regEmail'");
							$result = mysqli_fetch_assoc($query);
							...
							if($regEmail == $result['email']){
								...
								if($newP == $confirmP){
									...
									$query = mysqli_query("UPDATE members SET pwd = '$newP' WHERE email = '$regEmail'");
